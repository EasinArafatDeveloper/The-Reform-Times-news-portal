...
export default function InvestigationsPage() {
  ...
  const handleDelete = async (id: string) => {
    const result = await Swal.fire({
      ...
      text: isBangla ? 'এই রিপোর্টটি ডিলিট করতে চান?' : 'Do you want to delete this investigative dispatch?',
      icon: 'warning',
    ...
    try {
      ...
      if (res.ok) {
        ...
        toast.success(isBangla ? 'রিপোর্টটি সফলভাবে ডিলিট করা হয়েছে!' : 'Investigative dispatch deleted successfully!');
      } else {
