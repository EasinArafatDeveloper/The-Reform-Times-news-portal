...
export default function OpinionsPage() {
  ...
  const handleDelete = async (id: string) => {
    const result = await Swal.fire({
      ...
      text: isBangla ? 'এই মতামত নিবন্ধটি ডিলিট করতে চান?' : 'Do you want to delete this commentary column?',
      icon: 'warning',
    ...
    try {
      ...
      if (res.ok) {
        ...
        toast.success(isBangla ? 'নিবন্ধটি সফলভাবে ডিলিট করা হয়েছে!' : 'Commentary column deleted successfully!');
      } else {
