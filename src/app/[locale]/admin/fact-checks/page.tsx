...
export default function FactChecksPage() {
  ...
  const handleDelete = async (id: string) => {
    const result = await Swal.fire({
      ...
      text: isBangla ? 'এই ফ্যাক্ট চেকটি ডিলিট করতে চান?' : 'Do you want to delete this fact check dispatch?',
      icon: 'warning',
    ...
    try {
      ...
      if (res.ok) {
        ...
        toast.success(isBangla ? 'ফ্যাক্ট চেকটি সফলভাবে ডিলিট করা হয়েছে!' : 'Fact check dispatch deleted successfully!');
      } else {
