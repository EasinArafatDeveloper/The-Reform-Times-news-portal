...
export default function ArticlesPage() {
  ...
  const handleDelete = async (id: string) => {
    const result = await Swal.fire({
      ...
      text: isBangla ? 'আপনি কি নিশ্চিত যে আপনি এই আর্টিকেলটি ডিলিট করতে চান? এই কাজ আর ফিরিয়ে নেওয়া যাবে না।' : 'Are you sure you want to delete this article? This action cannot be undone.',
      icon: 'warning',
    ...
    try {
      ...
      if (res.ok) {
        ...
        toast.success(isBangla ? 'আর্টিকেলটি সফলভাবে ডিলিট করা হয়েছে!' : 'Article deleted successfully!');
      } else {
        toast.error(isBangla ? 'ডিলিট করতে ব্যর্থ হয়েছে!' : 'Failed to delete article!');
      }
    } catch (err) {
      toast.error(isBangla ? 'ডিলিট করার সময় সমস্যা হয়েছে!' : 'Error deleting article!');
    }
  };
  ...
  const handleStatusChange = async (id: string, newStatus: string) => {
    try {
      ...
      if (res.ok) {
        ...
        toast.success(isBangla ? 'আর্টিকেলের স্ট্যাটাস সফলভাবে আপডেট করা হয়েছে!' : 'Article status updated successfully!');
      } else {
        toast.error(isBangla ? 'স্ট্যাটাস আপডেট করতে ব্যর্থ হয়েছে!' : 'Failed to update status!');
      }
    } catch (err) {
      toast.error(isBangla ? 'আপডেট করার সময় সমস্যা হয়েছে!' : 'Error updating status!');
    }
  };
