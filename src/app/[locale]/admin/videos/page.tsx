...
export default function VideoReportsPage() {
  ...
  const typeName = "Video Report";
  const sectionTitle = isBangla ? "ভিডিও রিপোর্টিং ডেস্ক" : "Broadcast & Video Reports";
  const sectionDesc = isBangla ? "ভিডিও রিপোর্ট এবং মাল্টিমিডিয়া কন্টেন্ট পাবলিশ করুন।" : "Manage on-the-scene broadcasts, documentaries, and video reports.";
    ...
    <div className="space-y-10 text-body relative">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
        <div>
          <div className="flex items-center gap-2 text-red-500 font-bold text-xs uppercase tracking-widest mb-1.5">
            <Video size={16} /> Broadcast Studio
          </div>
        ...
        <Link 
          ...
          className="flex items-center justify-center gap-2 bg-red-600 text-white px-6 py-3 rounded-2xl font-bold hover:bg-red-700 hover:scale-[1.02] active:scale-[0.98] transition-all shadow-lg shadow-red-600/10 cursor-pointer"
        >
          <Plus size={20} />
          {isBangla ? 'নতুন ভিডিও আপলোড করুন' : 'Dispatch Video'}
        </Link>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-card p-6 border border-border rounded-[24px] flex items-center gap-4">
          <div className="w-12 h-12 rounded-xl bg-red-500/10 text-red-500 flex items-center justify-center"><Video size={24} /></div>
          <div>
            <p className="text-[10px] font-bold text-caption uppercase tracking-widest">Total Broadcasts</p>
        ...
        <div className="bg-card p-6 border border-border rounded-[24px] flex items-center gap-4">
          ...
          <div>
            <p className="text-[10px] font-bold text-caption uppercase tracking-widest">Draft Uploads</p>
            <p className="text-xl font-bold text-title mt-1">
            ...
            <button
              ...
              className={cn(
                ...
                selectedStatus === status 
                  ...
                  : "bg-card text-caption border-border hover:border-red-600 hover:text-title"
              )}
            >
              ...
              {isLoading ? (
                ...
                <tr>
                  <td colSpan={4} className="px-6 py-12 text-center text-caption font-bold uppercase tracking-widest text-xs">
                    No video report dispatches found.
                  </td>
                </tr>
                  ...
                  <tr key={articleId} className="hover:bg-surface transition-colors group">
                    <td className="px-6 py-4">
                      <div className="flex flex-col">
                        <span className="font-bold text-title group-hover:text-red-500 transition-colors line-clamp-1">
