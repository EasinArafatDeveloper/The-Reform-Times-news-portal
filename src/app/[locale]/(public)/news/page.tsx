        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          <div className="lg:col-span-8">
            ...
            <div className="flex items-center justify-center gap-2 border-t border-gray-200 pt-8">
              <button className="px-4 py-2 text-sm font-semibold text-gray-500 hover:text-brand-navy disabled:opacity-50" disabled>
              ...
              <button className="px-4 py-2 text-sm font-semibold text-brand-navy hover:text-brand-red">
          ...
          <div className="lg:col-span-4 flex flex-col gap-10">
            {/* Search Bar */}
            <div>
              <h3 className="font-serif font-bold text-lg border-b-2 border-brand-navy pb-2 mb-4">
                {t('search')}
              </h3>
            ...
            <div>
              ...
              <ul className="flex flex-col gap-2">
                {categories.map(cat => (
                  <li key={cat.id}>
                    <Link href={`/${locale}/category/${cat.slug}`} className="text-gray-600 hover:text-brand-red transition-colors flex justify-between items-center text-sm font-medium py-1">
